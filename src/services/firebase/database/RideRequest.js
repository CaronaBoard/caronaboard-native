...
import type { rideType, rideRequestFlowType } from '../types'
...
export const updateRideRequest = async (rideRequest: rideRequestFlowType, userId: string, profile: profileFlowType) => {
